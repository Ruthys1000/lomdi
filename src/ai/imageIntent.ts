/**
 * "רמז תמונה" — התיאור שמודל שפה משאיר במקום תמונה.
 *
 ...
 * הקליטה שולפת את הרמז הזה ושומרת אותו כ-`imagePrompt` — פרומפט מומלץ
 * שהמשתמש יכול להעתיק למחולל תמונות משלו. Lomdi עצמו לא מייצר תמונות.
 *
