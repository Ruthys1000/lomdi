  ...
  return (
    <div>
      ...
      <button
        ...
        className="mt-2 flex w-full items-center justify-center gap-1.5 rounded-lg border border-dashed border-slate-300 px-3 py-2 text-xs font-semibold text-slate-600 transition hover:border-blue-400 hover:text-blue-700 disabled:cursor-not-allowed disabled:opacity-40"
      >
    ...
    >
      <div className="mb-2 flex items-center gap-0.5">
        <button
          ...
          className="cursor-grab rounded p-1 text-slate-300 transition hover:text-slate-600 active:cursor-grabbing"
          {...attributes}
          {...listeners}
        >
        ...
        <button
          ...
          className="rounded p-1 text-slate-400 transition hover:bg-red-50 hover:text-red-600 disabled:opacity-30"
        >
