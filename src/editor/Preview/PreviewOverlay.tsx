...
export function PreviewOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-slate-900" role="dialog" aria-modal="true" aria-label="תצוגה מקדימה">
        ...
        <div className="flex items-center gap-0.5 rounded-lg bg-white/10 p-0.5">
          {devices.map(({ id, label, icon: Icon }) => (
            <button
              ...
              className={
                viewport === id
                  ? 'rounded-md bg-white px-2 py-1.5 text-slate-900'
                  : 'rounded-md px-2 py-1.5 text-slate-300 hover:text-white'
              }
            >
      ...
      <div className="min-h-0 flex-1 overflow-y-auto bg-slate-800 p-4">
        <div
